 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.collabTexteditorService.JoinSessionResponse)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.collabTexteditorService.SessionResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.collabTexteditorService.LocalUpdateReply)}
 *     callback The callback function(error, response)
